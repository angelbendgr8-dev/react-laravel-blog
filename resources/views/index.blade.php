    ...
    <section class="mag-posts-area d-flex flex-wrap">
        ...
        <div class="mag-posts-content mt-30 mb-30 p-30 box-shadow">
            ...
            <div class="trending-now-posts mb-30">
                ...
                <div class="trending-post-slides ">
                    <!-- Single Trending Post -->
                    
                    @foreach ($trending as $news)
                        <div class="single-trending-post">
                            <img src="{{URL::asset('storage/pictures/'.$news->post_img)}}" class="img-fluid" alt="">
                            <div class="post-content">
                                <a href="#" class="post-cata">
                                    @php
                                        $category = DB::table('categories')->where('id',$news->id)->select('name')->first();
                                    @endphp
                                    {{$category->name}}
                                </a>
                                <a href="{{ route('single.post',$news->id) }}" class="post-title">{{$news->title}}</a>
                            </div>
                        </div>
                    @endforeach
